...
4. Get the Account ID from Account Home kebab menu (⋮)
...
```
Bin\ChannelLinter_d64.exe -n CloudFlareWorkerKV -a "inputid" -a "outputid" -a "useragent" -a "accountid" -a "apitoken" -a "c3test" -i
```