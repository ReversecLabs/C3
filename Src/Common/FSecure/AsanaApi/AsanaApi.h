...
namespace FSecure
{
	...
	public:
		...
		AsanaApi(std::string const& userAgent, std::string const& token, std::string const& projectId, std::string const& inboundDirectionName, std::string const& outboundDirectionName);
