...
namespace FSecure
{
	...
	public:
		...
		Mattermost(std::string serverUrl, std::string userName, std::string teamName, std::string accessToken, std::string  channelName, std::string userAgent, std::string proxyOverride);
