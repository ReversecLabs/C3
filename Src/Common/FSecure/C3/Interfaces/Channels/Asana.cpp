...
{
	auto [header, token, projectId] = arguments.Read<std::string, std::string, std::string>();
	m_asanaObj = FSecure::AsanaApi{ header, token, projectId, m_inboundDirectionName, m_outboundDirectionName };
