...
{
	auto [userAgent, token, projectId, proxyOverride] = arguments.Read<std::string, std::string, std::string, std::string>();
	m_asanaObj = FSecure::AsanaApi{ userAgent, token, projectId, m_inboundDirectionName, m_outboundDirectionName, proxyOverride };
