...
size_t FSecure::C3::Interfaces::Channels::OneDrive365RestFile::OnSendToChannel(ByteView data)
{
	...
	try
	{
		...
		web::http::client::http_client client(utility::conversions::to_string_t(URLwithFilename), m_HttpConfig);
	...
	try
	{
		...
		.then([&](pplx::task<std::wstring> taskData)
		{
			...
			for (auto& element : taskDataAsJSON.at(OBF("value")))
			{
				...
				web::http::client::http_client clientFile(utility::conversions::to_string_t(element.at(OBF("@microsoft.graph.downloadUrl")).get<std::string>()), m_HttpConfig);
				...
				{
					if (response.status_code() == web::http::status_codes::OK) // ==200
						fileAsString = utility::conversions::to_utf8string(response.extract_string().get());
				});
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
const char* FSecure::C3::Interfaces::Channels::OneDrive365RestFile::GetCapability()
{
	return R"_(
{
	"create":
