#pragma once
#include "Common/FSecure/Zoom/ZoomApi.h"

namespace FSecure::C3::Interfaces::Channels
{
	///Implementation of the Zoom Channel.
	struct Zoom : public Channel<Zoom>
	{
		/// Public constructor.
		/// @param arguments factory arguments.
		Zoom(ByteView arguments);
		...
		/// Set long delay otherwise Zoom rate limit will heavily impact channel.
	...
	protected:
		...
		/// Delete Zoom channel messages only.
		void DeleteAllMessages();

	private:
		/// An object encapsulating Zoom's API, providing methods allowing the consumer to send and receive messages to Zoom, among other things.
		FSecure::Zoom m_ZoomObj;
