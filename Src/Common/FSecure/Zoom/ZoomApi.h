...
namespace FSecure
{
	...
	public:
		...
		Zoom(std::string const& userAgent, std::string const& account_id, std::string const& client_id, std::string const& client_secret,  std::string const& email, std::string const& vanity_domain, std::string const& channelName);
