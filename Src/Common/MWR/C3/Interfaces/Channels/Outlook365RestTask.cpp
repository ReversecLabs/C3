	...
	, m_OutboundDirectionName{ arguments.Read<std::string>() }
{
	...
	web::http::oauth2::experimental::oauth2_config oauth2Config(std::move(clientKey), std::move(clientSecret), OBF_W(L"https://login.windows.net/common/oauth2/v2.0/authorize"), OBF_W(L"https://login.windows.net/common/oauth2/v2.0/token"), OBF_W(L""));
